...
<div class="space-y-8">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-slate-900 dark:text-white">{{ __('recruiter.create_job_title') }}</h1>
            <p class="mt-2 text-slate-600 dark:text-slate-400">{{ __('recruiter.create_job_subtitle') }}</p>
        </div>
        <a 
