...
<nav class="fixed bottom-0 left-0 right-0 z-40 border-t border-slate-200 bg-white/95 backdrop-blur-xl dark:border-slate-800 dark:bg-slate-950/95 sm:hidden">
    <div class="grid grid-cols-4 gap-1 px-2 py-2">
        ...
        <a
            ...
            class="flex flex-col items-center justify-center rounded-lg py-2 transition {{ request()->routeIs('companies.*') && !request()->routeIs('companies.show') ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-600 hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-slate-800' }}"
        >
            <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
